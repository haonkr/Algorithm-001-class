...
# 테스트 코드
text = "ABABDABACDABABABCABABABABCABABABABCABABCA"
pattern = "ABABCABAB"
...
def knapsackFrac_greedy(weights, values, w):
    ...
    for ratio, wgt, val, idx in items: # 비율이 높은 순서부터 물건 채워넣기
        ...
        if w >= wgt : # 물건을 통채로 넣을 수 있는 경우
            ...
            bag_with_items.append(("part", idx, w, val * fraction)) # 물건을 일부 넣음
            w = 0 # 가방이 꽉 찬 상태
            break
